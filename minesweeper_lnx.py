...
def KeyPress(key):
    ...
    if active: #if not game over
        ...
        elif key.keycode >= 24 and key.keycode <= 61 and key.keycode != 36: #q-m, not enter
            if len(playerName) < 3:
...
def BindKey(key):
    ...
    if key.keycode in [23, 36, 22, 9, upKey[0], leftKey[0], downKey[0], rightKey[0]]: #forbidden keys
...
def CreatePauseMenu():
    ...
    tk.Button(pauseMenu, text="SAVE", command=SaveGame, bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="#13e843", bd=1).place(x=90, y=80)
...
def StartGame():
    ...
    cursor = gameArea.create_image(maxW/2, maxH/2, image=crss)
    sweeper = gameArea.create_arc((maxW/2)-126, (maxH/2)-126, (maxW/2)+126, (maxH/2)+126, start=90, extent=90, outline="#0f3e15", fill="#0f3e15", width=4)
...
tk.Button(startMenu, text="EASY", command=lambda: NewGame(8, 8), bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="#13e843", bd=1).place(x=15,y=60)
tk.Button(startMenu, text="MEDIUM", command=lambda: NewGame(10, 14), bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="#13e843", bd=1).place(x=75,y=60)
tk.Button(startMenu, text="HARD", command=lambda: NewGame(12, 24), bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="#13e843", bd=1).place(x=155,y=60)
tk.Button(startMenu, text="LOAD GAME", command=LoadGame, bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="#13e843", bd=1).place(x=65,y=100)
codeInput = tk.Entry(startMenu, width=12, bg="#002305", fg="#13e843",justify="center")
codeInput.place(x=67,y=125)
tk.Button(startMenu, text="LEADERBOARD", command=DisplayLeaderboard, bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="#13e843", bd=1).place(x=60,y=165)
tk.Button(startMenu, text="SETTINGS", command=DisplaySettings, bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="#13e843", bd=1).place(x=78,y=205)
tk.Button(startMenu, text="QUIT", command=quit, bg="#002305", activebackground="#002305", fg="#13e843", activeforeground="red", bd=1).place(x=94,y=285)
